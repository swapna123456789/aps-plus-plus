...
Class.machineGun = {PARENT: "spreadGun"}
Class.sniper = {
    PARENT: "genericTank",
    LABEL: "Sniper",
    BODY: {
...
Class.architect = makeRadialAuto("architectGun", {isTurret: true, size: 12, label: "Architect", body: {SPEED: 1.1 * base.SPEED}})
Class.assembler = {
    PARENT: "genericTank",
    LABEL: 'Assembler',
    STAT_NAMES: statnames.trap,
...
Class.bomber = makeGuard("triAngle", "Bomber")
Class.boomer = {
    PARENT: "genericTank",
    LABEL: "Boomer",
    STAT_NAMES: statnames.trap,
...
Class.eagle = makeBird("launcher", "Eagle")
Class.engineer = {
    PARENT: "genericTank",
    LABEL: "Engineer",
    STAT_NAMES: statnames.trap,
...
Class.landGrabber = {
    PARENT: "genericTank",
    LABEL: "Land Grabber",
    UPGRADE_TOOLTIP: "Primary fire to shoot your main gun.\nSecondary fire to summon a singular sentry.\nTank contributed by §#161B54§Taureon",
    STAT_NAMES: statnames.mixed,
    BODY: { SPEED: 0.75 * base.SPEED, FOV: 1.25 * base.FOV },
    GUNS: [{
        POSITION: [23, 2, 1, 0, -2.5, 0, 0],
        PROPERTIES: { SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.power, g.twin, { recoil: 1.5, speed: 1.2 }]), TYPE: "bullet" }
    }, {
        ...
        POSITION: [5, 15, 1, 5, 0, 0, 0],
    }, {
        POSITION: [3, 18, 1, 10, 0, 0, 0],
    }, {
        POSITION: [2, 18, 1.25, 13, 0, 0, 0],
        PROPERTIES: { MAX_CHILDREN: 1, SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.destroyer, { damage: 0.25, reload: 3 }]), TYPE: "landGrabberSentry", ALT_FIRE: true, SYNCS_SKILLS: true, DESTROY_OLDEST_CHILD: true, STAT_CALCULATOR: "block" },
    }, {
        POSITION: [4, 18, 1, 3, 0, 0, 0],
    }]
}

// Upgrade Paths
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "pounder", "spreadGun", "flankGuard", "pilot"/*, "desmos"*/]
    Class.basic.UPGRADES_TIER_2 = ["smasher"]
        Class.smasher.UPGRADES_TIER_3 = ["megaSmasher", "spike", "landmine"/*, "cocci"*/]
        Class.healer.UPGRADES_TIER_3 = ["medic", "ambulance", "surgeon", "paramedic"]

    Class.twin.UPGRADES_TIER_2 = ["twinFlank", "triplet", "gunner"/*, "helix"*/]
        Class.twin.UPGRADES_TIER_3 = ["dual", "bulwark", "musket"]
        Class.twinFlank.UPGRADES_TIER_3 = ["tripleFlank", "quadAngle"]
        Class.triplet.UPGRADES_TIER_3 = ["quintuplet", "tripleFlank", "battery"/*, "triplex"*/]
        Class.gunner.UPGRADES_TIER_3 = ["battery", "nailgun", "machineGunner", "gunnerTrapper", "commodore"]

    Class.sniper.UPGRADES_TIER_2 = ["assassin", "hunter", "rifle", "chainGun", "marksman"]
        Class.sniper.UPGRADES_TIER_3 = ["bushwhacker"]
        Class.assassin.UPGRADES_TIER_3 = ["ranger", "falcon", "stalker", "gatlingGun", "deadeye"]
        Class.hunter.UPGRADES_TIER_3 = ["predator", "xHunter", "ordnance", "dual", "focal", "nimrod"]
        Class.rifle.UPGRADES_TIER_3 = ["musket", "crossbow", "revolver"]
        Class.marksman.UPGRADES_TIER_3 = ["deadeye", "nimrod", "revolver", "fork"]

    Class.pounder.UPGRADES_TIER_2 = ["destroyer", "trapper", "artillery", "launcher"]
        Class.destroyer.UPGRADES_TIER_3 = ["shotgun", "annihilator", "conqueror", "megaTrapper"]
        Class.trapper.UPGRADES_TIER_3 = ["megaTrapper", "engineer", "boomer", "assembler", "architect", "conqueror"]
            //Class.engineer.UPGRADES_TIER_6 = ["landGrabber"]
        Class.artillery.UPGRADES_TIER_3 = ["mortar", "ordnance", "fieldGun"]
        Class.launcher.UPGRADES_TIER_3 = ["skimmer", "twister", "rocketeer", "eagle", "fieldGun"]

    Class.spreadGun.UPGRADES_TIER_2 = ["blaster", "chainGun", "sprayer", "minigun"]
        Class.blaster.UPGRADES_TIER_3 = ["flamethrower", "splasher", "machineGunner"]
        Class.chainGun.UPGRADES_TIER_3 = ["gatlingGun", "focal", "streamliner"]
        Class.sprayer.UPGRADES_TIER_3 = ["atomizer", "redistributor", "phoenix", "splasher", "focal"]
        Class.minigun.UPGRADES_TIER_3 = ["streamliner", "nailgun", "barricade", "redistributor"]

    Class.flankGuard.UPGRADES_TIER_2 = ["triAngle", "trapGuard", "twinFlank"]
        Class.flankGuard.UPGRADES_TIER_3 = ["quadruplex"]
        Class.triAngle.UPGRADES_TIER_3 = ["booster", "fighter", "bomber", "surfer", "quadAngle", "falcon", "eagle", "phoenix"]
        Class.trapGuard.UPGRADES_TIER_3 = ["bushwhacker", "gunnerTrapper", "bomber", "conqueror", "bulwark"]
            //Class.gunnerTrapper.UPGRADES_TIER_6 = ["landGrabber"]

    Class.pilot.UPGRADES_TIER_2 = ["captain", "cruiser", "mage", "spawner"]
        Class.pilot.UPGRADES_TIER_3 = ["phantom", "torpedo"]
        Class.captain.UPGRADES_TIER_3 = ["admiral", "commodore", "commander"]
        Class.cruiser.UPGRADES_TIER_3 = ["carrier", "battleship", "commander"]
        Class.mage.UPGRADES_TIER_3 = ["necromancer", "maleficitor", "infestor"]
        Class.spawner.UPGRADES_TIER_3 = ["factory"/*, "ranch"*/]
